    ...
    return(
        <Container fluid>
            <Row className='row-cols-auto d-flex justify-content-between align-items-center'>
                ...
                <Col>
                    <h2 className='app-header-cart'><Link to='card'><i className="mx-2 fas fa-shopping-cart"/></Link>{booksCount} Books ({priceCount}<i className="mx-1 fas fa-dollar-sign"/>)</h2>
                </Col>
            </Row>
        </Container>
    )
